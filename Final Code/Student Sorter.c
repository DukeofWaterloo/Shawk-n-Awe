 ...
 if ( sortedclass[class1-1][0] >= 1 && sortedclass[class2-1][1] >= 1 && sortedclass[class3-1][2] >= 1 && sortedclass[class4-1][3] >= 1){
    ...
    andrew = andrew +1;}}
           ...
           if(boss == 1){
                ...
                ComputerApplications1 = fopen("ComputerApplications attendance.txt", "w+");
                FILE * DesignandTechnology1;
                DesignandTechnology1  = fopen("DesignandTechnology attendance.txt", "w+");
                FILE * FamilyStudies1;
                FamilyStudies1 = fopen("FamilyStudies attendance.txt", "w+");
                FILE * MusicVocals1;
                MusicVocals1 = fopen("MusicVocals attendance.txt", "w+");
                FILE * Guidance1;
                Guidance1 = fopen("Guidance attendance.txt", "w+");
                FILE * Drama1;
                Drama1 = fopen("Drama attendance.txt", "w+");
                FILE * Art1;
                Art1 = fopen("Art attendance.txt", "w+");
