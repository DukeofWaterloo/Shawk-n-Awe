...
printf("\n\n\n\t\t\t %d %d %d %d %d %d\n",techcount,artcount,musiccount,dramacount,computercount,othercount);
{
    ...
    {
        sortedclass [0][fil] = studentcap[2];
        sortedclass [1][fil] = studentcap[1];
        sortedclass [2][fil] = studentcap[4];
        sortedclass [3][fil] = studentcap[5];
        sortedclass [4][fil] = studentcap[3];
        sortedclass [5][fil] = studentcap[0];
...
if (studentchoice[sh].choice1 == 0 || studentchoice[sh].choice2 == 0 || studentchoice[sh].choice3 == 0 || studentchoice[sh].choice4 == 0)
  ...
  for (int g = 0; g <= 3; g++)
  {
           c1 =  studentcap[2] - sortedclass [0][g];
           c2 = studentcap[1] - sortedclass [1][g];
           c3 = studentcap[4] - sortedclass [2][g];
           c4 = studentcap[5] - sortedclass [3][g];
           c5 = studentcap[3] - sortedclass [4][g];
           c6 = studentcap[0] - sortedclass [5][g];
...
{
    for(int check = 0; check <= heck; check++)
{
    if (studentchoice[check].class1 != 0 && studentchoice[check].class2 != 0 && studentchoice[check].class3 != 0 && studentchoice[check].class4 != 0)
    {
        ...
        {
            printf("\n\n\t\t\t\t\t%d %d %d %d %d",check,studentchoice[check].class1,studentchoice[check].class2,studentchoice[check].class3,studentchoice[check].class4 );
            sortedclass[studentchoice[check].class1 - 1][0]++;
            sortedclass[studentchoice[check].class2 - 1][1]++;
            sortedclass[studentchoice[check].class3 - 1][2]++;
            sortedclass[studentchoice[check].class4 - 1][3]++;
            noclassstudents[fail] = check;
            fail = fail +1;
        }
    }
}
...
{int class1,class2,class3,class4;
    ...
    {
int po1[7][2] = {sortedclass [0][0],1,sortedclass [1][0],2,sortedclass [2][0],3,sortedclass [3][0],4,sortedclass [4][0],5,sortedclass [5][0],6};
int po2[7][2] = {sortedclass [0][1],1,sortedclass [1][1],2,sortedclass [2][1],3,sortedclass [3][1],4,sortedclass [4][0],5,sortedclass [5][0],6};
int po3[7][2] = {sortedclass [0][2],1,sortedclass [1][2],2,sortedclass [2][2],3,sortedclass [3][2],4,sortedclass [4][0],5,sortedclass [5][0],6};
int po4[7][2] = {sortedclass [0][3],1,sortedclass [1][3],2,sortedclass [2][3],3,sortedclass [3][3],4,sortedclass [4][0],5,sortedclass [5][0],6};
for (int g = 0; g <= 9; g++) //first class
{
if(po1[0][0] < po1[1][0])
{
    shhhs = po1[0][0];
...
else if(po1[5][0] < po1[6][0])
{
    shhhs = po1[5][0];
    po1[5][0] = po1[6][0];
    po1[6][0] = shhhs; //class size
    shhhs = po1[5][1];
    po1[5][1] = po1[6][1];
    po1[6][1] = shhhs; // actual place
}
else{
        printf("\n%d %d %d %d %d %d",po1[0][0],po1[1][0],po1[2][0],po1[3][0],po1[4][0],po1[5][0]);
        printf("\n%d %d %d %d %d %d\n",po1[0][1],po1[1][1],po1[2][1],po1[3][1],po1[4][1],po1[5][1]);
        g = 10;
        }
}
for (int g = 0; g <= 9; g++) //first class
...
else if(po2[5][0] < po2[6][0])
{
    shhhs = po2[5][0];
    po2[5][0] = po2[6][0];
    po2[6][0] = shhhs; //class size
    shhhs = po2[5][1];
    po2[5][1] = po2[6][1];
    po2[6][1] = shhhs; // actual place
}
else{
        printf("\n%d %d %d %d %d %d",po2[0][0],po2[1][0],po2[2][0],po2[3][0],po2[4][0],po2[5][0]);
        printf("\n%d %d %d %d %d %d\n",po2[0][1],po2[1][1],po2[2][1],po2[3][1],po2[4][1],po2[5][1]);
        g = 10;
        }
}
 for (int g = 0; g <= 9; g++) //first class
...
else if(po3[5][0] < po3[6][0])
{
    shhhs = po3[5][0];
    po3[5][0] = po3[6][0];
    po3[6][0] = shhhs; //class size
    shhhs = po3[5][1];
    po3[5][1] = po3[6][1];
    po3[6][1] = shhhs; // actual place
}
else{

        printf("\n%d %d %d %d %d %d",po3[0][0],po3[1][0],po3[2][0],po3[3][0],po3[4][0],po3[5][0]);
        printf("\n%d %d %d %d %d %d\n",po3[0][1],po3[1][1],po3[2][1],po3[3][1],po3[4][1],po3[5][1]);
        g = 10;
        }
}
for (int g = 0; g <= 9; g++) //first class
...
else if(po4[5][0] < po4[6][0])
{
    shhhs = po4[5][0];
    po4[5][0] = po4[6][0];
    po4[6][0] = shhhs; //class size
    shhhs = po4[5][1];
    po4[5][1] = po4[6][1];
    po4[6][1] = shhhs; // actual place
}
else{
        printf("\n%d %d %d %d %d %d",po4[0][0],po4[1][0],po4[2][0],po4[3][0],po4[4][0],po4[5][0]);
        printf("\n%d %d %d %d %d %d\n",po4[0][1],po4[1][1],po4[2][1],po4[3][1],po4[4][1],po4[5][1]);
        g = 10;
        }
}
printf("\n\n\n");
...
if (gud == 1)
{
    ...
    if( po4[0][1] == class2||po4[0][1] == class3)
    {
        class4 = po4[1][1];
        if( po4[0][1] == class2||po4[0][1] == class3)
        {
...
if (gud == 2)
{
    ...
    if( po4[0][1] == class1||po4[0][1] == class3)
    {
        class4 = po4[1][1];
        if( po4[0][1] == class1||po4[0][1] == class3)
        {
...
if (gud == 3)
{
    ...
    if( po4[0][1] == class1||po4[0][1] == class2)
    {
        class4 = po4[1][1];
        if( po4[0][1] == class1||po4[0][1] == class2)
        {
...
if (gud == 4)
{
    ...
    if( po3[0][1] == class2||po3[0][1] == class1)
    {
        class3 = po3[1][1];
        if( po3[0][1] == class2||po3[0][1] == class1)
        {
...
printf(" %d: %d %d %d %d",d,class1,class2,class3,class4);
...
fail = 0;
  ...
  for (int k= 2; k <= heck; k++)
{
if(studentchoice[k].class1 == 0 || studentchoice[k].class2 == 0 || studentchoice[k].class3 == 0 || studentchoice[k].class4 == 0)
{
    printf("\t\t");
}
printf("%d %d %d %d %d\n",k,studentchoice[k].class1,studentchoice[k].class2,studentchoice[k].class3,studentchoice[k].class4);
}
}
studentchecker =1;
FILE * DoomGuy;
...
printf("this program was created by Keegan Andrus,"); //put your names in boys
