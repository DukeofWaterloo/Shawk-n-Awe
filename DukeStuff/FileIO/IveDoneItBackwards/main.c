...
int main()
{
    ...
    char* csvoutput ="./StudentTimeTables.csv";
    int n = 0;
    int lineTotal = 0;
    int CommaAmount = 0;
    int studentNumber = 0;
   ...
   if (fpo == NULL){
        printf("Could not open file %s", csvoutput);
        return 1;
    }
    ...
    fprintf(fpo,"Name, School, Teacher, Class1, Class2, Class3");
...
*/
        ...
        printf("\n%d, %s %s, %s, %s, %s, %s, %s", studentNumber, student[studentNumber].NameLast, student[studentNumber].NameFirst, student[studentNumber].School, student[studentNumber].Teacher, student[studentNumber].Choice1, student[studentNumber].Choice2, student[studentNumber].Choice3);
        fprintf(fpo,"\n%d, %s %s, %s, %s, %s, %s, %s, %s", studentNumber, student[studentNumber].NameLast, student[studentNumber].NameFirst, student[studentNumber].School, student[studentNumber].Teacher, student[studentNumber].Choice1, student[studentNumber].Choice2, student[studentNumber].Choice3, student[studentNumber].Choice4);
        fprintf(fpo,"\n%d, %s %s, %s, %s, %s, %s, %s, %s", studentNumber, student[studentNumber].NameLast, student[studentNumber].NameFirst, student[studentNumber].School, student[studentNumber].Teacher, student[studentNumber].Choice1, student[studentNumber].Choice2, student[studentNumber].Choice3, student[studentNumber].Choice4);
